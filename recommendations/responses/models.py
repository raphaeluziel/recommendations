...
class Responses(models.Model):
    ...
    question02 = models.CharField(max_length=5000, default='', blank=True)
    question03 = models.CharField(max_length=5000, default='', blank=True)
    question04 = models.CharField(max_length=5000, default='', blank=True)
